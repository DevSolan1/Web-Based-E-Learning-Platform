<div class="dashboard-sidebar p-3">
    ...
    $userObj = new User();
    $pendingTeachers = $userObj->getPendingTeachers();
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) === 'pending-teachers.php' ? 'active' : '' ?>" href="pending-teachers.php">
            <i class="bi bi-person-check me-2"></i>Pending Teachers
